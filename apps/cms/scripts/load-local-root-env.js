...
const loadLocalRootEnv = async () => {
  ...
  try {
    await writeFile(
      '.env',
      '# This file is generated by /apps/cms/scripts/load-local-root-env.ts\n' +
    ...
    console.log('\n\n\nSuccessfully loaded .env and .env.local from root to local dir\n\n\n')
  } catch (error) {
    console.error('\n\n\nFailed to load .env and/or .env.local from root to local dir', error, '\n\n\n')
  }
}
